...
namespace ai_it_wiki.Controllers
{
  ...
  public class LLMOpenAPIController : OpenApiControllerBase
  {
    ...
    //[SwaggerResponse(200, "Успешно сгенерирован текст", typeof(string))] //Исправить
    [SwaggerResponse(400, "Недопустимая длина (меньше 1 или больше 100 000 000)")]
    public IActionResult LengthCheck([FromBody] Models.LLM.LengthRequestDto request, int part = 1)
    {
