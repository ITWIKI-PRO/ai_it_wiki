  ...
  public class OpenAIService : OpenAIAPI, IOpenAiService
  {
    ...
    public async Task<string> GenerateImprovedContentAsync(string productInfo, string productDescription, CancellationToken cancellationToken = default)
    {
      ...
      var chatRequest = new ChatRequest()
      {
        ...
        Messages = new List<ChatMessage>
            {
                new ChatMessage(ChatMessageRole.System, "You are an expert in marketing and content creation. Generate an improved product description based on the provided product information and description. Ensure the content is engaging, concise, and highlights the key features and benefits of the product."),
                new ChatMessage(ChatMessageRole.User, $"Product Info: {productInfo}\nProduct Description: {productDescription}")
            }
      };
